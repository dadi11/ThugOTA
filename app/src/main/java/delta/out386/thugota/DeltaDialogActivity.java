...
public class DeltaDialogActivity extends Activity {
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(getApplication()).registerReceiver(notRomReciever, notRom);
        super.onResume();
    }
    @Override
    ...
    public void onPause() {
        ...
        LocalBroadcastManager.getInstance(getApplication()).unregisterReceiver(notRomReciever);
        super.onPause();
    }
    @Override
